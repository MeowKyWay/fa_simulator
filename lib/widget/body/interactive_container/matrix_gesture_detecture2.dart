...
/// [MatrixGestureDetector2] detects translation, scale and rotation gestures
...
/// parameters.
///
class MatrixGestureDetector2 extends StatefulWidget {
  ...
  @override
  State<MatrixGestureDetector2> createState() {
    return _MatrixGestureDetector2State();
  }
...
class _MatrixGestureDetector2State extends State<MatrixGestureDetector2> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onScaleStart: (details) => onScaleStart(details.focalPoint),
  ...
  void onPointerSignal(PointerSignalEvent event) {
    if (event is PointerScrollEvent) {
      ...
      details = ScaleUpdateDetails(
        focalPoint: event.position - translationDelta,
